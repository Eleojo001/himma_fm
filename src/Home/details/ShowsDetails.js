...
//   const [presnter, setPresnter] = useState("");
...
//     if (currentSong === index && audioRef.current) {
//       if (pause) {
//         // Resume playback
...
//     fetch(`https://himmaradiotv.ng/api/Media/GetByPodcastId/${id}`)
//       .then((res) => res.json())
//       .then((data) => {
//         console.log(data)
//         setShows(data.responseData);
//         setPresnter(data.responseData.presenter?.firstName + " " + data.responseData.presenter?.lastName);
//       });
...
//     };
//   }, [id]);
// console.log(presnter)
//   return (
//     <div>
//       <div className="presenterProfileContainer">
//     <div style={{padding: "10px 10px 30px"}}><h2>Listen to your podcast</h2></div>
...
//                     <Pause
//                       size={"60px"}
//                       onClick={() => handlePlay("https://himmaradiotv.ng/" + item.fileUrl, index)}
//                     />
//                   ) : (
//                     <Play
//                       size={"60px"}
...
//               alt=""
//               style={{ width: "100%", height: "100%", borderRadius: "10px", objectFit: "contain", cursor: "pointer" }}
//               className="eye-img"
//             />
//           </div>
